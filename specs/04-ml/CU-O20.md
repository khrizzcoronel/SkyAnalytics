...
*   **RF-O20-004:** El sistema debe integrar la telemetría del entrenamiento de la red neuronal profunda (TensorBoard / MLflow) para monitorear las curvas de pérdida (Loss curves) y prevenir sobreajuste (Overfitting).
...
*   Dashboards de TensorBoard incrustados en MLflow UI.
...
**Y** actualiza en tiempo real las métricas de Pérdida de Entrenamiento (Training Loss) en MLflow.
