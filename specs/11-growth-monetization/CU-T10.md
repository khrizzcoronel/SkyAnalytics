...
*   **Experimentos no destructivos:** Un A/B test de precios nunca altera el monto facturado a clientes existentes con contrato activo.
*   **Sandbox de Stripe:** Toda simulación de cobro durante el diseño del experimento usa Stripe Sandbox; no se procesan pagos reales.
