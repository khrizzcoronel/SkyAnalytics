...
*   **Sistemas Externos / Actores Secundarios:** Panel de facturación del PaaS API, Dashboard Básico / Sentry (Panel FinOps).
...
*   **RF-T08-001:** El sistema debe consumir los datos diariamente desde la API de Panel de facturación del PaaS y presentarlos en un dashboard (Dashboard Básico / Sentry FinOps).
*   **RF-T08-002:** El sistema debe desglosar los costos utilizando las etiquetas de Scripts básicos de despliegue (Tags: `Environment`, `Project`, `Owner`).
