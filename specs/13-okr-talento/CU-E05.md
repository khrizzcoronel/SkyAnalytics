...
*   **RNF-E05-002:** Los registros de creación y modificación de OKRs deben persistirse con un rastro de auditoría inmutable (Event Sourcing o tablas temporales).
...
*   **CA-E05-003:** Cada creación, modificación o publicación de OKRs deja un registro de auditoría inmutable (timestamp, autor, cambio anterior/nuevo) en una tabla de eventos o base temporal equivalente.
*   **CA-E05-004:** Al publicar OKRs, el sistema envía un resumen automatizado al canal `#anuncios-globales` en Slack con el título del objetivo, el responsable y los Key Results.
...
*   **Auditoría inmutable:** El historial de cambios de OKRs no puede eliminarse ni modificarse desde la UI; solo se puede agregar correcciones con justificación.
*   **Notificaciones Slack:** Si el webhook no está configurado, el sistema loguea un warning pero no bloquea la publicación.
