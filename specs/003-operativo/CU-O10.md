...
*   **Sistemas Externos / Actores Secundarios:** Sentry / Logs (Observabilidad), GitHub Actions.

## 4. Contexto del Problema
SkyAnalytics ofrece SLAs del 99.0% (Best Effort). Si durante un mes los incidentes ya causaron una caída de 4 minutos, solo quedan ~22 segundos permitidos antes de violar el contrato legal. Subir "nuevas funcionalidades" en ese momento es un riesgo enorme. El equipo debe priorizar arreglar problemas de confiabilidad (estabilización) antes de añadir innovación.

## 5. Requisitos Funcionales
*   **RF-O10-001:** Sentry / Logs debe calcular continuamente el "Presupuesto de Errores Consumido" basado en la ventana rotatoria de los últimos 30 días.
...
## 7. Reglas de Negocio
*   **RN-O10-001 (Regla de Congelamiento - Feature Freeze):** Al consumirse el 80% del Error Budget mensual (aprox. 3.5 minutos de caída detectada), se bloquean TODOS los *Merge* de nuevas características a la rama principal.
...
## 8. Entradas
*   Estado del SLO desde Sentry / Logs/Dashboard Básico / Sentry API.
