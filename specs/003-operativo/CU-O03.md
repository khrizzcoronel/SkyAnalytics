...
*   **RF-O03-001:** GitHub Actions debe ejecutar tareas cronometradas (DAGs) a las 02:00 UTC para iniciar la descarga segura de archivos desde los SFTP/Buckets de los proveedores.
...
*   **RF-O03-004:** Los datos normalizados deben cargarse en tablas `Staging` Logsrales dentro del Data Warehouse (PocketBase (Operativa) y MonetDB (Analítica)) usando procesos de carga masiva rápida (COPY INTO).
...
**Dado** que son las 02:00 UTC y el archivo `daily_flights_20261102.csv.gz` está listo en el SFTP
