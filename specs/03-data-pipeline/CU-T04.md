...
*   **RNF-T04-002:** Todos los logs de los pipelines ETL deben ser retenidos y accesibles (Loki/Elasticsearch) por al menos 90 días por motivos de auditoría SOC 2.
...
*   **Retención de logs:** Los logs de ejecución de DAGs se retienen 90 días para auditoría SOC 2, alineado con RNF-T04-002.
*   **Alertas no spam:** Un mismo error crónico no debe generar más de una alerta por hora en Slack (deduplicación).
