...
*   **Sistemas Externos / Actores Secundarios:** Grafana k6 (Load Testing), Litmus Chaos (Chaos Engineering), Notificaciones de Slack (Validación de alarmas).
...
*   **RF-T09-003:** Durante cualquier prueba de Chaos, el sistema de alertas habitual (Grafana LGTM stack/Notificaciones de Slack) DEBE dispararse como si fuera un evento real.
...
*   **Entorno gemelo:** Los experimentos destructivos nunca corren en producción; se requiere un Staging con topología idéntica.
*   **Kill switch obligatorio:** Toda prueba de carga o caos debe poder abortarse en menos de 5 segundos sin dejar recursos huérfanos.
